...
public class Main {
    ...
    private static void inputNumber() {
        ...
        System.out.println("Informe a coluna em que o número vai ser inserido:");
        var col = runUntilGetValidNumber(0, 8);
        System.out.println("Informe a linha em que o número vai ser inserido:");
    ...
    private static void clearGame() {
        ...
        System.out.println("Tem certeza que deseja limpar todo seu jogo e perder todo seu progresso?");
